...
enum OBJECT_TYPE
{
    ...
    OBJECT__STATION_TAIL,
    OBJECT__STATION_ARM,
    OBJECT__STATION_DRILL,
    OBJECT__STATION_BLADE,
    OBJECT__STATION_HAMMER,
    OBJECT__STATION_WHIP,
    OBJECT__STATION_GUN,
    OBJECT__STATION_SLINGSHOT,
    OBJECT__STATION_COIL,
    OBJECT__STATION_FLAME,
    OBJECT__STATION_FREEZE,
    OBJECT__STATION_LASER,
    
    OBJECT__STATION_BONUS_TURN_AFTER_KILL,
    OBJECT__STATION_BONUS_TURN_IF_MOVE_ONLY,
    OBJECT__STATION_FREE_MOVE_IF_DAM_ONLY,
