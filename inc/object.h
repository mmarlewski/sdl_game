...
enum OBJECT_TYPE
{
    ...
    OBJECT_TYPE__EXIT_MARBLE_UP,
    OBJECT_TYPE__EXIT_MARBLE_RIGHT,
    OBJECT_TYPE__EXIT_MARBLE_DOWN,
    OBJECT_TYPE__EXIT_MARBLE_LEFT,

    OBJECT_TYPE__EXIT_OBSIDIAN_UP,
    OBJECT_TYPE__EXIT_OBSIDIAN_RIGHT,
    OBJECT_TYPE__EXIT_OBSIDIAN_DOWN,
    OBJECT_TYPE__EXIT_OBSIDIAN_LEFT,
