...
typedef struct
{
    ...
    Texture* weapon_freeze;
    Texture* weapon_gun;
    Texture* weapon_hammer;
    Texture* weapon_laser;
    Texture* weapon_whip;
    ...
    Texture* skill_charge_and_jump;
    Texture* skill_freeze_water;
    Texture* skill_fire_weld_floor;
    Texture* skill_drag_and_throw;
    Texture* skill_pull;
    Texture* skill_telekinesis;
    Texture* skill_stunning_shot;
    Texture* skill_shoot_projectile;
    Texture* skill_jump;
    Texture* skill_cooking_bolt;
    Texture* skill_stomp;
    ...
    Texture* skill_ice_projectile;
    Texture* skill_head_slice;
    Texture* skill_bouncing_beam;
    Texture* skill_jump_and_carry;
    Texture* skill_swing;
    ...
    Texture* skill_charge_and_throw;
    Texture* skill_thrust;
    Texture* skill_ice_block;
    Texture* skill_punch;
    ...
    Texture* skill_turret_laser;
    Texture* skill_turret_bomb;
    Texture* skill_turret_projectile;
    Texture* skill_kill_around;

    Texture* object_golem;
    Texture* object_hero;
    Texture* object_goat;
    Texture* object_spider;
    Texture* object_bull;
    Texture* object_fly;
    Texture* object_chameleon;
    Texture* object_squid;
    Texture* object_mole;
    ...
    Texture* object_squirrel;
    Texture* object_minibot_ally;
    Texture* object_minibot_enemy;
    Texture* environment;
