...
#define ENEMY_PAUSE_LENGTH_IN_SECONDS 0.1f

#define ALLY_MAX_ACTION_POINTS 1
...
#define SKILL_ROCKET_JUMP_RANGE 5
#define SKILL_CHARGE_RANGE 2
#define SKILL_ROCKET_CHARGE_RANGE 10
