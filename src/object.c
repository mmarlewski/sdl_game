...
int is_object_enemy(Object* object)
{
    ...
    switch(object->type)
    {
        ...
        case OBJECT__LION:                             is = 1; break;
        case OBJECT__GORILLA:                          is = 1; break;
        case OBJECT__DRAGON:                           is = 1; break;
        case OBJECT__FROG:                             is = 1; break;
        case OBJECT__RABBIT:                           is = 1; break;
        case OBJECT__CENTIPEDE:                        is = 1; break;
        case OBJECT__GRASSHOPPER:                      is = 1; break;
        case OBJECT__MEGASPIDER:                       is = 1; break;
        case OBJECT__PORCUPINE:                        is = 1; break;
        case OBJECT__AARDVARK:                         is = 1; break;
        case OBJECT__WORM:                             is = 1; break;
...
int is_object_pull_towards(Object* object)
{
    ...
    switch(object->type)
    {
        ...
        case OBJECT__STATION_SLINGSHOT:                is = 1; break;
...
int get_station_augmentation(Object* object)
{
    ...
    switch(object->type)
    {
        ...
        case OBJECT__STATION_SLINGSHOT:            augmentation = AUGMENTATION__SLINGSHOT; break;
...
int is_object_movable(Object* object)
{
    ...
    switch(object->type)
    {
        ...
        case OBJECT__MEGASPIDER:                       is = 1; break;
        case OBJECT__PORCUPINE:                        is = 1; break;
        case OBJECT__AARDVARK:                         is = 0; break;
        case OBJECT__WORM:                             is = 0; break;
...
int is_object_metal(Object *object)
{
    ...
    switch(object->type)
    {
        ...
        case OBJECT__STATION_SLINGSHOT:
...
int get_object_max_hp(Object* object)
{
    ...
    switch(object->type)
    {
        ...
        case OBJECT__LION:                          max_hp = 3; break;
        case OBJECT__GORILLA:                       max_hp = 3; break;
        case OBJECT__DRAGON:                        max_hp = 3; break;
        case OBJECT__FROG:                          max_hp = 3; break;
...
char* get_debug_name_from_object_type(int object_type)
{
    ...
    switch(object_type)
    {
        ...
        case OBJECT__LION:                             name = "lion"; break;
        case OBJECT__GORILLA:                          name = "gorrila"; break;
        case OBJECT__DRAGON:                           name = "dragon"; break;
        case OBJECT__FROG:                             name = "frog"; break;
        case OBJECT__RABBIT:                           name = "rabbit"; break;
        case OBJECT__CENTIPEDE:                        name = "centipede"; break;
        case OBJECT__GRASSHOPPER:                      name = "grasshopper"; break;
        case OBJECT__MEGASPIDER:                       name = "megaspider"; break;
        case OBJECT__PORCUPINE:                        name = "porcupine"; break;
        case OBJECT__AARDVARK:                         name = "aardvark"; break;
        case OBJECT__WORM:                             name = "worm"; break;
        ...
        case OBJECT__STATION_TAIL:                     name = "station tail"; break;
        case OBJECT__STATION_ARM:                      name = "station arm"; break;
        case OBJECT__STATION_DRILL:                    name = "station drill"; break;
        case OBJECT__STATION_BLADE:                    name = "station blade"; break;
        case OBJECT__STATION_HAMMER:                   name = "station hammer"; break;
        case OBJECT__STATION_WHIP:                     name = "station whip"; break;
        case OBJECT__STATION_GUN:                      name = "station gun"; break;
        case OBJECT__STATION_SLINGSHOT:                name = "station slingshot"; break;
        case OBJECT__STATION_COIL:                     name = "station coil"; break;
...
char* get_in_game_name_from_object_type(int object_type)
{
    ...
    switch(object_type)
    {
        ...
        case OBJECT__COVER_ROCK:                       name = "cover"; break;
        case OBJECT__COVER_METAL:                      name = "cover"; break;
        case OBJECT__COVER_GLASS:                      name = "cover"; break;

        case OBJECT__CRATE_GEMSTONE:                   name = "crate"; break;
        case OBJECT__CRATE_GEMSTONE_ITEM:              name = "crate"; break;

        case OBJECT__CRATE_CELL:                       name = "crate"; break;
        case OBJECT__CRATE_CELL_ITEM:                  name = "crate"; break;

        case OBJECT__CRATE_DYNAMITE:                   name = "crate"; break;
        case OBJECT__CRATE_DYNAMITE_ITEM:              name = "crate"; break;

        case OBJECT__ROCK:                             name = "rock"; break;
        case OBJECT__ROCK_DAMAGED:                     name = "rock"; break;
        case OBJECT__ROCK_DAMAGED_ITEM:                name = "rock"; break;

        case OBJECT__SAFE:                             name = "safe"; break;
        case OBJECT__SAFE_DAMAGED:                     name = "safe"; break;
        case OBJECT__SAFE_DAMAGED_ITEM:                name = "safe"; break;

        case OBJECT__DISPLAY:                          name = "display"; break;
        case OBJECT__DISPLAY_DAMAGED:                  name = "display"; break;
        case OBJECT__DISPLAY_DAMAGED_ITEM:             name = "display"; break;
        ...
        case OBJECT__HERO_FLYING:                      name = "hero"; break;
        ...
        case OBJECT__ENVIRONMENT_FALLING_STALACTITE:   name = "environment"; break;
        case OBJECT__ENVIRONMENT_EMERGE_WATER:         name = "environment"; break;
        case OBJECT__ENVIRONMENT_EMERGE_PIT:           name = "environment"; break;
        case OBJECT__ENVIRONMENT_EMERGE_BURROW:        name = "environment"; break;
        case OBJECT__ENVIRONMENT_EMERGE_PIPE:          name = "environment"; break;
        ...
        case OBJECT__STATION_CHAIN_HAND:               name = "station"; break;
        case OBJECT__STATION_SCISSOR_HAND:             name = "station"; break;
        case OBJECT__STATION_SPRING_LEG:               name = "station"; break;
        case OBJECT__STATION_STRIDER_LEG:              name = "station"; break;
        case OBJECT__STATION_TRACK_LEG:                name = "station"; break;
        case OBJECT__STATION_BOOT_LEG:                 name = "station"; break;
        case OBJECT__STATION_MINIBOT_TORSO:            name = "station"; break;
        case OBJECT__STATION_WINGS_TORSO:              name = "station"; break;
        ...
        case OBJECT__STATION_SLINGSHOT:                name = "station"; break;
...
Texture* get_texture_1_from_object(Object* object, Textures* textures)
{
    ...
    switch(object->type)
    {
        ...
        case OBJECT__LION:                             texture = textures->object.lion; break;
        case OBJECT__GORILLA:                          texture = textures->object.gorilla; break;
        case OBJECT__DRAGON:                           texture = textures->object.dragon; break;
        case OBJECT__FROG:                             texture = textures->object.frog; break;
        case OBJECT__RABBIT:                           texture = textures->object.rabbit; break;
        case OBJECT__CENTIPEDE:                        texture = textures->object.centipede; break;
        case OBJECT__GRASSHOPPER:                      texture = textures->object.grasshopper; break;
        case OBJECT__MEGASPIDER:                       texture = textures->object.megaspider; break;
        case OBJECT__PORCUPINE:                        texture = textures->object.porcupine; break;
        case OBJECT__AARDVARK:                         texture = textures->object.aardvark; break;
        case OBJECT__WORM:                             texture = textures->object.worm; break;
        ...
        case OBJECT__STATION_SLINGSHOT:                texture = textures->object.station_slingshot; break;
...
Texture* get_texture_1_outline_from_object(Object* object, Textures* textures)
{
    ...
    switch(object->type)
    {
        ...
        case OBJECT__LION:                             texture = textures->object.lion_outline; break;
        case OBJECT__GORILLA:                          texture = textures->object.gorilla_outline; break;
        case OBJECT__DRAGON:                           texture = textures->object.dragon_outline; break;
        case OBJECT__FROG:                             texture = textures->object.frog_outline; break;
        case OBJECT__RABBIT:                           texture = textures->object.rabbit_outline; break;
        case OBJECT__CENTIPEDE:                        texture = textures->object.centipede_outline; break;
        case OBJECT__GRASSHOPPER:                      texture = textures->object.grasshopper_outline; break;
        case OBJECT__MEGASPIDER:                       texture = textures->object.megaspider_outline; break;
        case OBJECT__PORCUPINE:                        texture = textures->object.porcupine_outline; break;
        case OBJECT__AARDVARK:                         texture = textures->object.aardvark_outline; break;
        case OBJECT__WORM:                             texture = textures->object.worm_outline; break;
        ...
        case OBJECT__STATION_SLINGSHOT:                texture = textures->object.station_outline; break;
...
Texture* get_hud_texture_from_object(Object* object, Textures* textures)
{
    ...
    switch(object->type)
    {
        ...
        case OBJECT__LION:                             texture = textures->hud.object_lion; break;
        case OBJECT__GORILLA:                          texture = textures->hud.object_gorilla; break;
        case OBJECT__DRAGON:                           texture = textures->hud.object_dragon; break;
        case OBJECT__FROG:                             texture = textures->hud.object_frog; break;
        case OBJECT__RABBIT:                           texture = textures->hud.object_rabbit; break;
        case OBJECT__CENTIPEDE:                        texture = textures->hud.object_centipede; break;
        case OBJECT__GRASSHOPPER:                      texture = textures->hud.object_grasshopper; break;
        case OBJECT__MEGASPIDER:                       texture = textures->hud.object_megaspider; break;
        case OBJECT__PORCUPINE:                        texture = textures->hud.object_porcupine; break;
        case OBJECT__AARDVARK:                         texture = textures->hud.object_aardvark; break;
        case OBJECT__WORM:                             texture = textures->hud.object_worm; break;
