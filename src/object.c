...
int is_object_enemy(Object* object)
{
    ...
    switch(object->type)
    {
        ...
        case OBJECT_TYPE__SQUID:                            is = 1; break;
...
int get_object_item_count(Object* object)
{
    ...
    switch(object->type)
    {
        ...
        case OBJECT_TYPE__CRATE_CELL_ITEM:                  count = 1; break;
...
char* get_name_from_object_type(int object_type)
{
    ...
    switch(object_type)
    {
        ...
        case OBJECT_TYPE__SQUID:                            name = "squid"; break;
...
Texture* get_texture_1_from_object(Object* object, Textures* textures)
{
    ...
    switch(object->type)
    {
        ...
        case OBJECT_TYPE__SQUID:                            texture = textures->object.squid_1; break;
...
Texture* get_texture_2_from_object(Object* object, Textures* textures)
{
    ...
    switch(object->type)
    {
        ...
        case OBJECT_TYPE__SQUID:                            texture = textures->object.squid_2; break;
...
Texture* get_texture_1_outline_from_object(Object* object, Textures* textures)
{
    ...
    switch(object->type)
    {
        ...
        case OBJECT_TYPE__SQUID:                            texture = textures->object.squid_outline_1; break;
...
Texture* get_texture_2_outline_from_object(Object* object, Textures* textures)
{
    ...
    switch(object->type)
    {
        ...
        case OBJECT_TYPE__SQUID:                            texture = textures->object.squid_outline_2; break;
