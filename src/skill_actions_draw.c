    ...
    //     break;
        ...
        case SKILL__HEAD_SHOT:
        {
            ...
            if(distance_info.dir4 != DIR4__NONE)
            {
                ...
                if(object != NULL && (is_object_ally(object) || is_object_enemy(object)) && back_object == NULL)
                {
                    // actions
                    add_action_to_end_action_sequence(
                        action_sequence,
        ...
        case SKILL__DOUBLE_JUMP:
        {
            ...
            if(jump_1_distance_info.dir4 != DIR4__NONE && jump_2_distance_info.dir4 != DIR4__NONE)
            {
                ...
                add_action_to_end_action_sequence(
                    action_sequence,
                    new_action_damage(target_1_object, 2)
                );
        ...
        case SKILL__JUMP_AND_NAIL:
        {
            ...
            for(ListElem* list_elem = nail_tilemap_pos_list->head; list_elem != NULL; list_elem = list_elem->next)
            {
                ...
                if(is_tilemap_in_bounds(tilemap_pos))
                {
                    ...
                    if(object != NULL && (is_object_ally(object) || is_object_enemy(object)) && object != state->hero_object)
                    {
                        // actions
                        add_action_to_end_action_sequence(
                            action_sequence,
        ...
        case SKILL__PENETRATING_THRUST:
        {
            ...
            if(distance_info.dir4 != DIR4__NONE)
            {
                ...
                Vec2i tilemap_pos_2 = vec2i_move_in_dir4_by(tilemap_pos_1, distance_info.dir4, 1);
                ...
                if(object_1 != NULL && (is_object_ally(object_1) || is_object_enemy(object_1)))
                {
                    // actions
                    add_action_to_end_action_sequence(
                        action_sequence,
                        new_action_damage(object_1, 1)
                    );
                ...
                if(object_2 != NULL && (is_object_ally(object_2) || is_object_enemy(object_2)))
                {
                    // actions
                    add_action_to_end_action_sequence(
                        action_sequence,
                        new_action_damage(object_2, 1)
                    );
