...
void load_textures_object(Renderer* renderer, Textures_Object* object)
{
    ...
    object->station_slingshot = load_texture_from_filepath(renderer, "./res/object/station_slingshot.png");
...
{
    hud->aug_none = load_texture_from_filepath(renderer, "./res/hud/aug_none.png");
    hud->aug_spring = load_texture_from_filepath(renderer, "./res/hud/aug_spring.png");
    hud->aug_track = load_texture_from_filepath(renderer, "./res/hud/aug_track.png");
    hud->aug_tail = load_texture_from_filepath(renderer, "./res/hud/aug_tail.png");
    hud->aug_minibot = load_texture_from_filepath(renderer, "./res/hud/aug_minibot.png");
    ...
    hud->weapon_slingshot = load_texture_from_filepath(renderer, "./res/hud/weapon_slingshot.png");
    ...
    hud->weapon_freeze = load_texture_from_filepath(renderer, "./res/hud/weapon_freeze.png");
    hud->weapon_gun = load_texture_from_filepath(renderer, "./res/hud/weapon_gun.png");
    hud->weapon_hammer = load_texture_from_filepath(renderer, "./res/hud/weapon_hammer.png");
    hud->weapon_laser = load_texture_from_filepath(renderer, "./res/hud/weapon_laser.png");
    hud->weapon_whip = load_texture_from_filepath(renderer, "./res/hud/weapon_whip.png");
    ...
    hud->skill_whip_smack_weird = load_texture_from_filepath(renderer, "./res/hud/skill_whip_smack_weird.png");
    ...
    hud->skill_charge_and_jump = load_texture_from_filepath(renderer, "./res/hud/skill_charge_and_jump.png");
    hud->skill_freeze_water = load_texture_from_filepath(renderer, "./res/hud/skill_freeze_water.png");
    hud->skill_fire_weld_floor = load_texture_from_filepath(renderer, "./res/hud/skill_fire_weld_floor.png");
    hud->skill_drag_and_throw = load_texture_from_filepath(renderer, "./res/hud/skill_drag_and_throw.png");
    hud->skill_pull = load_texture_from_filepath(renderer, "./res/hud/skill_pull.png");
    hud->skill_telekinesis = load_texture_from_filepath(renderer, "./res/hud/skill_telekinesis.png");
    hud->skill_stunning_shot = load_texture_from_filepath(renderer, "./res/hud/skill_stunning_shot.png");
    hud->skill_shoot_projectile = load_texture_from_filepath(renderer, "./res/hud/skill_shoot_projectile.png");
    hud->skill_jump = load_texture_from_filepath(renderer, "./res/hud/skill_jump.png");
    hud->skill_cooking_bolt = load_texture_from_filepath(renderer, "./res/hud/skill_cooking_bolt.png");
    ...
    hud->skill_ice_projectile = load_texture_from_filepath(renderer, "./res/hud/skill_ice_projectile.png");
    hud->skill_head_slice = load_texture_from_filepath(renderer, "./res/hud/skill_head_slice.png");
    hud->skill_bouncing_beam = load_texture_from_filepath(renderer, "./res/hud/skill_bouncing_beam.png");
    hud->skill_jump_and_carry = load_texture_from_filepath(renderer, "./res/hud/skill_jump_and_carry.png");
    hud->skill_swing = load_texture_from_filepath(renderer, "./res/hud/skill_swing.png");
    hud->skill_penetrating_thrust = load_texture_from_filepath(renderer, "./res/hud/skill_penetrating_thrust.png");
    hud->skill_high_projectile = load_texture_from_filepath(renderer, "./res/hud/skill_high_projectile.png");
    hud->skill_high_exploading_projectile = load_texture_from_filepath(renderer, "./res/hud/skill_high_exploading_projectile.png");
    ...
    hud->skill_charge_and_throw = load_texture_from_filepath(renderer, "./res/hud/skill_charge_and_throw.png");
    hud->skill_thrust = load_texture_from_filepath(renderer, "./res/hud/skill_thrust.png");
    hud->skill_ice_block = load_texture_from_filepath(renderer, "./res/hud/skill_ice_block.png");
    hud->skill_punch = load_texture_from_filepath(renderer, "./res/hud/skill_punch.png");
    hud->skill_manipulation = load_texture_from_filepath(renderer, "./res/hud/skill_manipulation.png");
    hud->skill_ice_wall = load_texture_from_filepath(renderer, "./res/hud/skill_ice_wall.png");
    hud->skill_rocket_dash = load_texture_from_filepath(renderer, "./res/hud/skill_rocket_dash.png");
    hud->skill_whip_pull_weird = load_texture_from_filepath(renderer, "./res/hud/skill_whip_pull_weird.png");
    hud->skill_stunning_bolt = load_texture_from_filepath(renderer, "./res/hud/skill_stunning_bolt.png");
    hud->skill_charge_and_push = load_texture_from_filepath(renderer, "./res/hud/skill_charge_and_push.png");
    hud->skill_simple_shot = load_texture_from_filepath(renderer, "./res/hud/skill_simple_shot.png");
    hud->skill_sniper_shot = load_texture_from_filepath(renderer, "./res/hud/skill_sniper_shot.png");
    hud->skill_ricoshet = load_texture_from_filepath(renderer, "./res/hud/skill_ricoshet.png");
    hud->skill_harpoon_shot = load_texture_from_filepath(renderer, "./res/hud/skill_harpoon_shot.png");
    hud->skill_drill_floor = load_texture_from_filepath(renderer, "./res/hud/skill_drill_floor.png");
    hud->skill_bury = load_texture_from_filepath(renderer, "./res/hud/skill_bury.png");
    hud->skill_double_jump = load_texture_from_filepath(renderer, "./res/hud/skill_double_jump.png");
    hud->skill_whip_smack = load_texture_from_filepath(renderer, "./res/hud/skill_whip_smack.png");
    hud->skill_whip_drag = load_texture_from_filepath(renderer, "./res/hud/skill_whip_drag.png");
    hud->skill_whip_pull = load_texture_from_filepath(renderer, "./res/hud/skill_whip_pull.png");
    hud->skill_whip_turn = load_texture_from_filepath(renderer, "./res/hud/skill_whip_turn.png");
    hud->skill_arm_turn = load_texture_from_filepath(renderer, "./res/hud/skill_arm_turn.png");
    hud->skill_whip_yeet = load_texture_from_filepath(renderer, "./res/hud/skill_whip_yeet.png");
    hud->skill_arm_yeet = load_texture_from_filepath(renderer, "./res/hud/skill_arm_yeet.png");
    
    hud->skill_launch_minibot = load_texture_from_filepath(renderer, "./res/hud/skill_launch_minibot.png");
    hud->skill_minibot_merge = load_texture_from_filepath(renderer, "./res/hud/skill_minibot_merge.png");
    hud->skill_turret_laser = load_texture_from_filepath(renderer, "./res/hud/skill_turret_laser.png");
    hud->skill_turret_bomb = load_texture_from_filepath(renderer, "./res/hud/skill_turret_bomb.png");
    hud->skill_turret_projectile = load_texture_from_filepath(renderer, "./res/hud/skill_turret_projectile.png");
    hud->skill_kill_around = load_texture_from_filepath(renderer, "./res/hud/skill_kill_around.png");

    hud->object_hero = load_texture_from_filepath(renderer, "./res/hud/object_hero.png");
    hud->object_golem = load_texture_from_filepath(renderer, "./res/hud/object_golem.png");
    hud->object_goat = load_texture_from_filepath(renderer, "./res/hud/object_goat.png");
    hud->object_spider = load_texture_from_filepath(renderer, "./res/hud/object_spider.png");
    hud->object_bull = load_texture_from_filepath(renderer, "./res/hud/object_bull.png");
    hud->object_fly = load_texture_from_filepath(renderer, "./res/hud/object_fly.png");
    hud->object_chameleon = load_texture_from_filepath(renderer, "./res/hud/object_chameleon.png");
    hud->object_squid = load_texture_from_filepath(renderer, "./res/hud/object_squid.png");
    hud->object_mole = load_texture_from_filepath(renderer, "./res/hud/object_mole.png");
    ...
    hud->object_squirrel = load_texture_from_filepath(renderer, "./res/hud/object_squirrel.png");
    hud->object_minibot_ally = load_texture_from_filepath(renderer, "./res/hud/object_minibot_ally.png");
    hud->object_minibot_enemy = load_texture_from_filepath(renderer, "./res/hud/object_minibot_enemy.png");
