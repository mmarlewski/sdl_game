...
int is_floor_manipulatable(int floor)
{
    ...
    switch(floor)
    {
        ...
        case FLOOR_TYPE__METAL_SPIKES_ON:           is = 1; break;
        case FLOOR_TYPE__METAL_SPIKES_OFF:          is = 1; break;
...
int is_floor_traversable(int floor)
{
    ...
    switch(floor)
    {
        ...
        case FLOOR_TYPE__METAL_SPIKES_ON:           is = 0; break;
        case FLOOR_TYPE__METAL_SPIKES_OFF:          is = 1; break;
...
int is_floor_deadly_on_move(int floor)
{
    ...
    switch(floor)
    {
        ...
        case FLOOR_TYPE__STONE_TRAP:                is = 1; break;
        case FLOOR_TYPE__METAL_SPIKES_ON:           is = 1; break;
        case FLOOR_TYPE__METAL_SPIKES_OFF:          is = 0; break;
        case FLOOR_TYPE__METAL:                     is = 0; break;
        case FLOOR_TYPE__METAL_HATCH_OPEN:          is = 1; break;
...
int get_floor_item_type(int floor)
{
    ...
    switch(floor)
    {
        ...
        case FLOOR_TYPE__METAL_SPIKES_ON:           item = ITEM__NONE; break;
        case FLOOR_TYPE__METAL_SPIKES_OFF:          item = ITEM__NONE; break;
...
int get_floor_item_count(int floor)
{
    ...
    switch(floor)
    {
        ...
        case FLOOR_TYPE__METAL_SPIKES_ON:           count = 0; break;
        case FLOOR_TYPE__METAL_SPIKES_OFF:          count = 0; break;
...
char* get_name_from_floor(int floor)
{
    ...
    switch(floor)
    {
        ...
        case FLOOR_TYPE__METAL_SPIKES_ON:           name = "metal spikes on"; break;
        case FLOOR_TYPE__METAL_SPIKES_OFF:          name = "metal spikes off"; break;
...
Texture* get_texture_1_from_floor_type(int type, Textures* textures)
{
    ...
    switch(type)
    {
        ...
        case FLOOR_TYPE__METAL_SPIKES_ON:           texture = textures->floor.metal_spikes_on; break;
        case FLOOR_TYPE__METAL_SPIKES_OFF:          texture = textures->floor.metal_spikes_off; break;
