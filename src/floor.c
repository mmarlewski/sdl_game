...
int is_floor_traversable(int floor)
{
    ...
    switch(floor)
    {
        ...
        case FLOOR__PIT_COLUMN:                is = 1; break;
        case FLOOR__WATER:                     is = 0; break;
...
int is_floor_deadly_on_move(int floor)
{
    ...
    switch(floor)
    {
        ...
        case FLOOR__GRASS:                     is = 0; break;
        case FLOOR__PIT:                       is = 1; break;
        case FLOOR__PIT_COLUMN:                is = 0; break;
        case FLOOR__WATER:                     is = 1; break;
        case FLOOR__WATER_STALACTITE_FALLEN:   is = 0; break;
...
char* get_in_game_name_from_floor(int floor)
{
    ...
    switch(floor)
    {
        ...
        case FLOOR__METAL_SPIKES_ON:                    name = "spikes (on)"; break;
        case FLOOR__METAL_SPIKES_OFF:                   name = "metal (off)"; break;
        case FLOOR__METAL:                              name = "metal"; break;
        case FLOOR__METAL_HATCH_OPEN:                   name = "hatch (on)"; break;
        case FLOOR__METAL_HATCH_CLOSED:                 name = "hatch (off)"; break;
        case FLOOR__METAL_COVER_BOTTOM:                 name = "metal"; break;
        case FLOOR__METAL_TARGET_UNCHECKED:             name = "target"; break;
        case FLOOR__METAL_TARGET_CHECKED:               name = "target"; break;
        case FLOOR__METAL_PISTON:                       name = "piston (off)"; break;
        case FLOOR__METAL_PISTON_CELL:                  name = "piston (off)"; break;
        case FLOOR__METAL_PISTON_DYNAMITE:              name = "piston (off)"; break;
        case FLOOR__METAL_PISTON_BARREL:                name = "piston (off)"; break;
        case FLOOR__METAL_PISTON_MIMIC:                 name = "piston (off)"; break;
        case FLOOR__METAL_NO_PISTON:                    name = "metal"; break;
        ...
        case FLOOR__PIT:                                name = "pit"; break;
        case FLOOR__PIT_COLUMN:                         name = "column"; break;
        ...
        case FLOOR__CONV_BELT_UP:                       name = "conv belt"; break;
        case FLOOR__CONV_BELT_RIGHT:                    name = "conv belt"; break;
        case FLOOR__CONV_BELT_DOWN:                     name = "conv belt"; break;
        case FLOOR__CONV_BELT_LEFT:                     name = "conv belt"; break;
        case FLOOR__STONE_STAIRS_BELOW:                 name = "stairs"; break;
        case FLOOR__STONE_STAIRS_BELOW_BLOCKED:         name = "stairs"; break;
        case FLOOR__STONE_STAIRS_ABOVE_UNPOWERED:       name = "stairs"; break;
        case FLOOR__STONE_STAIRS_ABOVE_POWERED:         name = "stairs"; break;
        case FLOOR__ROCK_STAIRS_BELOW:                  name = "stairs"; break;
        case FLOOR__METAL_STAIRS_BELOW_OFF:             name = "stairs"; break;
        case FLOOR__METAL_STAIRS_ABOVE_OFF:             name = "stairs"; break;
        case FLOOR__METAL_STAIRS_BELOW_ON:              name = "stairs"; break;
        case FLOOR__METAL_STAIRS_BELOW:                 name = "stairs"; break;
        case FLOOR__EXT_BRIDGE_SOURCE_ON_HORIZONTAL:    name = "bridge (on)"; break;
        case FLOOR__EXT_BRIDGE_SOURCE_OFF_HORIZONTAL:   name = "bridge (off)"; break;
        case FLOOR__EXT_BRIDGE_PART_HORIZONTAL:         name = "bridge"; break;
        case FLOOR__EXT_BRIDGE_SOURCE_ON_VERTICAL:      name = "bridge (on)"; break;
        case FLOOR__EXT_BRIDGE_SOURCE_OFF_VERTICAL:     name = "bridge (off)"; break;
        case FLOOR__EXT_BRIDGE_PART_VERTICAL:           name = "bridge"; break;
        default: break;
    }
...
char* get_debug_name_from_floor(int floor)
{
    ...
    switch(floor)
    {
        ...
        case FLOOR__COINS:                              name = "coins"; break;
        case FLOOR__PIT:                                name = "pit"; break;
        case FLOOR__PIT_COLUMN:                         name = "pit column"; break;
        case FLOOR__WATER:                              name = "water"; break;
...
Texture* get_texture_1_from_floor_type(int type, Textures* textures)
{
    ...
    switch(type)
    {
        ...
        case FLOOR__PIT_COLUMN:                texture = textures->floor.pit_column; break;
