...
char* get_in_game_name_from_floor(int floor)
{
    ...
    switch(floor)
    {
        ...
        case FLOOR__METAL_HATCH_OPEN:                   name = "hatch"; break;
        case FLOOR__METAL_HATCH_CLOSED:                 name = "hatch"; break;
        ...
        case FLOOR__METAL_PISTON:                       name = "piston"; break;
        case FLOOR__METAL_PISTON_CELL:                  name = "piston"; break;
        case FLOOR__METAL_PISTON_DYNAMITE:              name = "piston"; break;
        case FLOOR__METAL_PISTON_BARREL:                name = "piston"; break;
        case FLOOR__METAL_PISTON_MIMIC:                 name = "piston"; break;
        ...
        case FLOOR__EXT_BRIDGE_SOURCE_ON_HORIZONTAL:    name = "bridge"; break;
        case FLOOR__EXT_BRIDGE_SOURCE_OFF_HORIZONTAL:   name = "bridge"; break;
        case FLOOR__EXT_BRIDGE_PART_HORIZONTAL:         name = "bridge"; break;
        case FLOOR__EXT_BRIDGE_SOURCE_ON_VERTICAL:      name = "bridge"; break;
        case FLOOR__EXT_BRIDGE_SOURCE_OFF_VERTICAL:     name = "bridge"; break;
