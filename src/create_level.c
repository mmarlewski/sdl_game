...
void create_level(State* state, Textures* textures)
{
    ...
    room_add_object_at(
        room_0_3,
        new_object(OBJECT__EXIT_GOLD_LOCKED_UP),
        vec2i(8, 9)
    );
    room_add_object_at(
        room_0_3,
    ...
    room_add_object_at(
        room_1_3,
        new_object(OBJECT__EXIT_GOLD_LOCKED_DOWN),
        vec2i(8, 0)
    );
    room_add_object_at(
        room_1_3,
